...
const CollectionSpotlight: React.FC = () => {  return (
    <div className="flex flex-wrap justify-center flex-row " style={{ backgroundColor: "#F9F8FF", padding: "40px" }}>
      ...
      {[1, 2, 3].map((index) => (
        <Card key={index} className=" shadow-md  m-2" style={{ margin:"15px" ,width:"260px" ,backgroundColor: '#FFFFFF' }}>
          <CardHeader className="p-2 relative "  style={{borderBottomLeftRadius:150}}  >
            ...
            style={{ width:"90%", margin:"5%", borderRadius: '5px', border: 'none' }}>
